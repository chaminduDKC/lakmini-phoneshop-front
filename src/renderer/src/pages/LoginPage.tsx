...
import { Smartphone, Eye, EyeOff, CheckCircle, User, Lock } from 'lucide-react'
import { useAuthStore } from '../stores/authStore'
import { ErrorMessage } from '../components/ErrorMessage'
import LOGO from '../../../../build/logo.jpeg'
...
export const LoginPage: React.FC = () => {
  ...
  const features = ['Repair Job Tracking', 'Spare Parts Inventory', 'Category & Stock Management', 'Sales & Reports']
      ...
      <div className="hidden lg:flex flex-col justify-center px-20 py-20 w-1/2 bg-linear-to-br from-[var(--color-bg-secondary)] to-[var(--color-bg-primary)] border-r border-[var(--color-border)] relative">
        ...
        <div className="z-10 animate-fade-in">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-5xl font-black text-white tracking-tight leading-none">LMS</h1>
          ...
          <h2 className="text-3xl font-bold text-white mb-6 leading-tight">
            Stock. Repair. Track<br />
            <span className="text-[var(--color-accent)]">counter to workshop.</span>
          </h2>

          <p className="text-[var(--color-text-secondary)] text-lg mb-10 max-w-md">
            Manage spare parts inventory, track repair jobs, and keep every category and phone model organized in one place.
          </p>
          ...
          <div className="p-10">
            ...
            <div className="mt-8 pt-6 border-t border-[var(--color-border)] flex items-center justify-center gap-2">
              ...
              <span className="mono text-xs text-center text-[var(--color-text-muted)]">
                Lakmini Mobile Management System v1.0.0 &copy; {year}
              </span>
            </div>
          </div>
        </div>
