...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'md', marginTop }) => {
  useEffect(() => {
      ...
      {isOpen && (
        <>
          <motion.div
            ...
            onClick={onClose}
          />
          <div className= {`fixed inset-0 z-50 flex mt-${marginTop} items-center justify-center p-4 pointer-events-none`}>
            <motion.div
